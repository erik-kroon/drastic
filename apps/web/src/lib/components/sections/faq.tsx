      ...
      <Accordion type="single" collapsible className="w-full" defaultValue="3">
        {items2.map((item) => (
          <AccordionItem value={item.id} key={item.id} className="py-2">
            ...
            <AccordionContent className="pb-2 ps-7 text-muted-foreground break-words">
              {item.content}
            </AccordionContent>
          </AccordionItem>
        ))}
