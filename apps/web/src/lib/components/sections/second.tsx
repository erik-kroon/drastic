...
export function SecondSection() {
  ...
  return (
    <div className=" w-full overflow-hidden">
      ...
      <div className="relative -mt-64  z-50 h-96 w-full overflow-hidden [mask-image:radial-gradient(50%_50%,white,transparent)]">
        <div className="absolute inset-0 before:absolute before:inset-0 before:bg-[radial-gradient(circle_at_bottom_center,#8350e8,transparent_70%)] before:opacity-40" />
        <div className="absolute top-1/2 -left-1/2 z-40 aspect-[1/0.6] w-[200%] rounded-[100%] border-t border-zinc-900/20 bg-white dark:border-white/20 dark:bg-zinc-900" />
        <Sparkles
          density={1200}
      ...
      <div className="h-[1900px] -mt-20 z-50 text-4xl w-full flex justify-center items-center flex-col gap-32">
